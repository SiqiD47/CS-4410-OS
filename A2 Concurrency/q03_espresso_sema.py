...
class EspressoCzar(MP):
	...
	def __init__(self, max_coffee_bean_units):
		...
		self.machineEmpty = self.Semaphore('machine is empty', max_coffee_bean_units)
	...
	def refill_espresso_machine(self, refill_unit):
		...
		"""
		# TODO implement me
		self.machineEmpty.procure()
		self.mutex.procure()
		self.deque.append(refill_unit)
		self.mutex.vacate()
		self.machineFull.vacate()
	...
	def make_espresso(self):
		...
		"""
		# TODO implement me
		self.machineFull.procure()
		self.mutex.procure()
		refill_unit = self.deque.popleft()
		self.mutex.vacate()
		self.machineEmpty.vacate()
		return refill_unit
